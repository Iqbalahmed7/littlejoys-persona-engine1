    ...
    return {
        "nutrimix_2_6": {
            "general_non_temporal": [
                ...
                _i(
                    id="nm26_school_partnership_launch",
                    name="School Nutrition Partnership",
                    description="Activate school-channel partnership to reach engaged parent communities.",
                    scope="general",
                    temporality="non_temporal",
                    target_cohort_id=None,
                    parameter_modifications={"marketing.school_partnership": True},
                    expected_mechanism="School credibility signal broadens reach to community-oriented parents.",
                ),
            ],
            "general_temporal": [
                _i(
                    id="nm26_lj_pass_premium_discount",
                    name="LJ Pass — Enhanced 25% Discount Tier",
                    description="Boost LJ Pass benefit to 25% cashback to accelerate subscription uptake.",
                    scope="general",
                    temporality="temporal",
                    target_cohort_id=None,
                    parameter_modifications={
                        "lj_pass.discount_percent": 25.0,
                        "marketing.discount_available": 0.20,
                    },
                    expected_mechanism="Higher perceived value drives first subscription and locks in habit.",
                ),
                _i(
        ...
        "magnesium_gummies": {
            ...
            "general_temporal": [
                _i(
                    ...
                    description="Guided sequence to anchor nightly habit, backed by a school-channel push.",
                    scope="general",
                    temporality="temporal",
                    target_cohort_id=None,
                    parameter_modifications={
                        "marketing.school_partnership": True,
                        "marketing.awareness_budget": 0.65,
                    },
                    expected_mechanism="School channel + raised awareness converts routine browsers into buyers.",
                ),
            ],
            "cohort_non_temporal": [
                _i(
                    id="mg_skeptic_doctor_card",
                    name="Skeptic Cohort: Clinically-backed FAQ Card",
                    description="Medical FAQ insert + reduced trial price for trust-sensitive households.",
                    scope="cohort_specific",
                    temporality="non_temporal",
                    target_cohort_id="trust_skeptics",
                    parameter_modifications={
                        "product.price_inr": 379.0,
                        "marketing.discount_available": 0.18,
                    },
                    expected_mechanism="Lower trial price + credibility signal lowers entry barrier for skeptics.",
                ),
            ],
            "cohort_temporal": [
                _i(
