"""Smoke tests for Streamlit page imports and question bank integrity (Sprint 13)."""

from __future__ import annotations

import ast
import pytest
from src.probing.question_bank import list_all_questions, get_tree_for_question
from src.simulation.auto_variants import generate_business_variants, BusinessVariant, VariantBatch
